const about = {
  equipoMotor: `La primera edición de <a href="https://www.museoreinasofia.es/actividades/equipomotor target="_blank"">equipoMotor</a>,
    ...
    <br />
    <br />
    Inspiradas por la obra <i>TXT</i> de Ana Torfs, viajamos a través de la Colección Permanente para
    conocerla
    y preguntarnos: ¿qué ideas o conceptos conectan los diferentes Episodios? ¿Cómo circulan las palabras a
    través de las obras y los espacios?
    <br />
    <br />
    El programa se articuló a través de 8 sesiones presenciales y la creación de otros tantos boletines
    digitales, un material de mediación comunitaria que construye un glosario compartido de lectura
    colectiva.
    <br>
    <br>
    ...
    Coordinado por Desmusea entre marzo y junio del año 2022 y acompañada por Torta Colectivo, Yuri Tuma y
    Fabiana
  ...
  episodes: `Este proyecto nace en el contexto de la exposición <a href="https://www.museoreinasofia.es/coleccion" target="_blank" >Vasos Comunicantes</a>, en el Museo Reina Sofía, que está compuesta de ocho Episodios. Cada uno de ellos presenta una
  historia, un relato
